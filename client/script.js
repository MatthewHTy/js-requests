...
const repeatMyParam = () => {
    axios.get('http://localhost:3000/repeat/CodeWorked')
    .then(res => {
        console.log(res.data)
        let repeatBtn = document.getElementById('repeat-text');
...
// axios.get('http://localhost:3000/repeat?myquery=
// .then(({ data }) => console.log(data))

let query = () => {
    axios.get('http://localhost:3000/query-test?test=${sayHelloButton}')
    .then(res => {
        console.log(res.data)
    })
}

// axios.get('http://localhost:3000/querytest?myquery=query-test${querytest')
// .then(({ data }) => console.log(data))
